...
/**
 * This class is in charge of making the Joystick easy to assign things to buttons and invert the axes of the joystick. The class
 * uses joystick as the main joystick, and uses button values and enums in order to assign thing to those buttons.
 *
 * @see Joystick
 * @see JoystickButton
 */
